...
# Hardware requirements: Ubuntu 20.04 instance with minimum t2.medium type instance & port 9000 (sonarqube), 9100 (node-exporter) should be allowed on the security groups
